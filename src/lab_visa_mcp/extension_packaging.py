...
`lab-executor-mcp`. Importing `lab_visa_mcp.extension_packaging`
now forwards to `lab_executor.extension_packaging` with a DeprecationWarning.

Migration:
    # old
    from lab_visa_mcp.extension_packaging import X
    # new
...
_warnings.warn(
    "lab_visa_mcp.extension_packaging is deprecated; "
