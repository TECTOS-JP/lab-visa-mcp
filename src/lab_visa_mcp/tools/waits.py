"""Re-export of ``lab_executor.tools.waits`` (visa-mcp v2.8.2).
...
Import ``lab_executor.tools.waits`` directly in new code.
"""

from __future__ import annotations

from lab_executor.tools.waits import *  # noqa: F401,F403
from lab_executor.tools import waits as _upstream
