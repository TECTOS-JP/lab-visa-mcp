"""Re-export of ``lab_executor.tools.dsl`` (visa-mcp v2.8.2).
...
Import ``lab_executor.tools.dsl`` directly in new code.
"""

from __future__ import annotations

from lab_executor.tools.dsl import *  # noqa: F401,F403
from lab_executor.tools import dsl as _upstream
