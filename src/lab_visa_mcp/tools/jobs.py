"""Re-export of ``lab_executor.tools.jobs`` (visa-mcp v2.8.2).
...
Import ``lab_executor.tools.jobs`` directly in new code.
"""

from __future__ import annotations

from lab_executor.tools.jobs import *  # noqa: F401,F403
from lab_executor.tools import jobs as _upstream
