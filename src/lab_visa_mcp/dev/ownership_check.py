...
Usage:
    python -m lab_visa_mcp.dev.ownership_check
    python -m lab_visa_mcp.dev.ownership_check --json
    python -m lab_visa_mcp.dev.ownership_check --graph-md docs/separation/dependency_graph.md
...
LAZY_EXCEPTIONS = {
    ...
    ("lab_visa_mcp.testing.mock_instruments", "lab_visa_mcp.visa_manager"),
}
...
def render_graph_md(report: dict[str, Any]) -> str:
    ...
    out.append("> `python -m lab_visa_mcp.dev.ownership_check --graph-md "
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m lab_visa_mcp.dev.ownership_check",
        description=(
