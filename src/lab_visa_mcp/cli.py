...
def cmd_serve(args: argparse.Namespace) -> int:
    from lab_visa_mcp.server import main as server_main
...
def cmd_extension(args: argparse.Namespace) -> int:
    ...
    if sub == "uninstall":
        if getattr(args, "dry_run", False):
            from lab_visa_mcp.extension_integrity import uninstall_dry_run
    ...
    if sub == "inspect":
        from lab_visa_mcp.extension_integrity import inspect_installed_extension
        ...
        if args.json:
            ...
            print(f"lab_visa_mcp_ver   : {rep['lab_visa_mcp_version']}")
    ...
    if sub == "inspect-package":
        from lab_visa_mcp.extension_catalog import inspect_package
    ...
    if sub == "package":
        ...
        if getattr(args, "dry_run", False):
            from lab_visa_mcp.extension_authoring import package_dry_run
    ...
    if sub == "verify-package":
        from lab_visa_mcp.extension_packaging import verify_extension_package
    ...
    if sub == "doctor":
        from lab_visa_mcp.extension_authoring import doctor_extension
    ...
    if sub == "add-instrument":
        from lab_visa_mcp.instrument_authoring import add_instrument_to_pack
...
def cmd_instrument(args: argparse.Namespace) -> int:
    ...
    if args.inst_command == "promote-check":
        from lab_visa_mcp.instrument_authoring import promote_check_instrument
...
def cmd_registry(args: argparse.Namespace) -> int:
    ...
    from lab_visa_mcp.extension_install import load_overlay_registry
